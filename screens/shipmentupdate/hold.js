...
export default function Hold({ navigation }) {
            ...
            <ScrollView style={tw`bg-red-50`}>                
                ...
                {/* form */}
                    <View style={tw`px-4 py-4 mx-2 my-8 bg-red-100 rounded-lg`}>
                        <Text style={tw`text-xl font-bold text-center text-gray-900 underline`}>Update Hold Status</Text>
                        <View style={tw`mt-4`}>
                        ...
                        <View style={tw`mt-6`}>
                            <Text style={tw`text-base font-semibold`}>Reason:</Text>
                            <Picker
                            ...
                            style={tw`h-10 px-4 mt-1 text-lg text-gray-700 border-2 border-gray-400 rounded-lg`}
                            >
                                <Picker.Item label="Customer refused" value="Customer refused" />                             
                                <Picker.Item label="Door locked" value="Door locked" />                             
                                <Picker.Item label="Customer not available" value="Customer not available" />                             
                                <Picker.Item label="Wrong address" value="Wrong address" />                             
                                <Picker.Item label="Wrong consignee" value="Wrong consignee" />                             
                                <Picker.Item label="Not picking calls" value="Not picking calls" />                             
                                <Picker.Item label="Phone off" value="Phone off" />                             
                                <Picker.Item label="Change of location" value="Change of location" />                             
                            </Picker>
                            {isFieldInError('name') &&
