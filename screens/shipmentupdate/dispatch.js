            ...
            <ScrollView style={tw`bg-red-50`}>
                ...
                {/* form */}
                    <View style={tw`px-4 py-4 mx-2 my-8 bg-red-100 rounded-lg`}>
                        <Text style={tw`text-xl font-bold text-center text-gray-900 underline`}>Update Dispatch Status </Text>
                        <View style={tw`mt-4`}>
                        ...
                        <View style={tw`mt-6`}>
                            <Text style={tw`text-base font-semibold text-gray-600`}>Name:</Text>
                            <TextInput
                        ...
                        <View style={tw`mt-6`}>
                            <Text style={tw`text-base font-semibold text-gray-600`}>ID Type:</Text>
                            <Picker
                        ...
                        <View style={tw`mt-4`}>
                            <Text style={tw`text-base font-semibold text-gray-600`}>ID Number:</Text>
                            <TextInput
